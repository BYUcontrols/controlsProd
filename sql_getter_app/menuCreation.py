...
def createMenus(app):
    pass
#     from sql_getter_app.collection import db   # pulls in db object from the collection module
...
def getMenuForRole(user):
    from sql_getter_app.menuCreation import rawMenu    # this must have been copied from another module because we are in the menuCreation module: not sure why they are importing from it here
